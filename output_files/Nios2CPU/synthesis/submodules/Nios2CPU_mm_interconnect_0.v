// Nios2CPU_mm_interconnect_0.v

// This file was auto-generated from altera_mm_interconnect_hw.tcl.  If you edit it your changes
// will probably be lost.
// 
// Generated using ACDS version 14.1 186 at 2015.07.02.11:05:29

`timescale 1 ps / 1 ps
module Nios2CPU_mm_interconnect_0 (
	...
	wire  [92:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire         ram_s1_agent_rdata_fifo_src_valid;                                           // RAM_s1_agent:rdata_fifo_src_valid -> RAM_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] ram_s1_agent_rdata_fifo_src_data;                                            // RAM_s1_agent:rdata_fifo_src_data -> RAM_s1_agent:rdata_fifo_sink_data
	wire         ram_s1_agent_rdata_fifo_src_ready;                                           // RAM_s1_agent:rdata_fifo_sink_ready -> RAM_s1_agent:rdata_fifo_src_ready
	...
	wire   [4:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> RAM_s1_agent:cp_channel
	...
	wire         pio_s1_agent_rdata_fifo_src_valid;                                           // PIO_s1_agent:rdata_fifo_src_valid -> PIO_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] pio_s1_agent_rdata_fifo_src_data;                                            // PIO_s1_agent:rdata_fifo_src_data -> PIO_s1_agent:rdata_fifo_sink_data
	wire         pio_s1_agent_rdata_fifo_src_ready;                                           // PIO_s1_agent:rdata_fifo_sink_ready -> PIO_s1_agent:rdata_fifo_src_ready
	...
	wire  [92:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (ram_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (ram_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (ram_s1_agent_rdata_fifo_src_data),        //                .data
	...
	altera_merlin_slave_agent #(
		...
		.rdata_fifo_sink_ready   (pio_s1_agent_rdata_fifo_src_ready),       // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (pio_s1_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_sink_data    (pio_s1_agent_rdata_fifo_src_data),        //                .data
	...
	Nios2CPU_mm_interconnect_0_router router (
	...
	Nios2CPU_mm_interconnect_0_router router_001 (
	...
	Nios2CPU_mm_interconnect_0_router_002 router_002 (
	...
	Nios2CPU_mm_interconnect_0_router_002 router_003 (
	...
	Nios2CPU_mm_interconnect_0_router_002 router_004 (
	...
	Nios2CPU_mm_interconnect_0_router_002 router_005 (
	...
	Nios2CPU_mm_interconnect_0_router_002 router_006 (
	...
	Nios2CPU_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_cmd_demux cmd_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_cmd_mux cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_demux rsp_demux_004 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	Nios2CPU_mm_interconnect_0_rsp_mux rsp_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), // clk_reset.reset
